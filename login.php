...
//SELECT D.Name,D.Relatntype from EMP E JOIN DEPENDENT D ON (E.ID = D.E_ID) done
//SELECT E.Fname,E.Lname,E.Minit,E.Minit,E.Phone,E.Salary from EMP E JOIN DEPT D ON (E.D_ID = D.Dnumber) where D.Mgr = 4
//SELECT P.Pname,P.Budget,P.St_date,P.Totalsales,D.Dnumber from PRODUCT P JOIN DEPT D ON(P.D_NO = D.Dnumber) where P.Head_id = 2 done
//
//SELECT D_ID, COUNT(*) FROM EMP GROUP BY D_ID done
//SELECT E.Fname,E.Lname,E.Minit,P.D_NO from EMP E JOIN PRODUCT P on(P.Head_id = E.ID) where P.D_NO = 2 done
//SELECT Name,Dnumber,Website from DEPT done
//SELECT Sname,Buildname,City,Country from LOCATION where D_no = 2 done
